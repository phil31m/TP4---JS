<template>
  <header class="site-header">
    <img src="images/logo-les-bonnes-pieces.png" alt="LOGO" id="site-logo">
  ...
  <main>
    ...
    <section class="filter-panel">
      <h3>Filtres</h3>
      <b>Par prix : </b>
      Croissant <input type="radio" v-model="prixFiltre" name="prixFiltre" value="croissant">
      Décroissant <input type="radio" v-model="prixFiltre" name="prixFiltre" value="decroissant"> 
      <br><br>
      <b>Par nom : </b>
      <input type="text" v-model="searchTitle" placeholder="Rechercher...">
      <br><br>
      <b>Disponibilité :</b> Disponibles 
      <input type="checkbox" v-model="dispoFiltre" name="dispoFiltre" value="dispo">
      Indisponibles 
      <input type="checkbox" v-model="dispoFiltre" name="dispoFiltre" value="indispo">
      <br><br>
      <b>Par catégorie : </b>
    ...
    <section class="products-container">
      <div class="product-card" v-for="p in filteredPieces" :key="p.id">
        <h3>{{ p.nom }}</h3>
        <img :src="p.Image" alt="Image produit">
        <p>Prix : {{ p.prix }}€</p>
        <p>Catégorie : {{ p.categorie }}</p>
        <p>Disponibilité : {{ p.Disponible ? 'Disponible' : 'Indisponible' }}</p>
        <button v-if="p.Disponible" @click="Ajouter(p)" class="btn-add">Ajouter au panier</button>
      </div>
    </section>
    <!-- Shopping Cart -->
